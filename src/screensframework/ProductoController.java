...
// PreparedStatement no estaba siendo importado en el ProductoController.java
    ...
    private void eliminarProducto(ActionEvent event) {
        ...
        if (confirmarEliminar == 0) {
            try {
                ...
                int n = estado.executeUpdate(); // linea 346 archivo ProductoController.java se estaba intentando utilizar una variable llama n que no estaba definidad
