...
public class RegistroController implements Initializable, ControlledScreen {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbAddsex.setItems(options); // linea 43 archivo RegistroController.java se estaba intentando usar una variable Options en UpperCase cuando estaba definida en lowercase como options
